...
-- =========================================================
-- 026_customer_card_return_confirm_alias_fix.sql
--
-- Corrige un alias incorrecto en
-- financial_confirm_card_return().
--
-- Antes:
--   UPDATE cards c ... WHERE cfl.card_id = ...
--
-- Correcto:
--   UPDATE cards c ... WHERE c.card_id = ...
--
-- Esta migración NO cambia saldos, tarjetas ni devoluciones.
